 ...
 * 
 */
public class SDLGraphics extends UnifiedGraphics {
	 ...
	 * SDL_Surface. This function also pushes a clip area corresponding to the dimension of the
	 * target.
	 * 
	 * @param target
