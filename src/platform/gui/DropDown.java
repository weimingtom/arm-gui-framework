 ...
 */
public class DropDown extends PlatformWidget implements MouseListener, KeyListener, ActionListener {
	private ListBox			m_defaultListBox;
	private ScrollArea		m_defaultScrollArea;

	protected int				m_nOldH;
	protected boolean			m_bPushed;
	protected boolean			m_bDroppedDown;
	...
	protected void adjustHeight() throws GUIException {
		...
		if (m_bDroppedDown && null != getParentWidget() ) {
			
			int h = getParentWidget().getHeight() - getY();
